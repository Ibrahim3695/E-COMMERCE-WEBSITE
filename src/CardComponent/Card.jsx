    ...
    <div className='card-main-div'>
      {
        getAllProducts.map((i) => (
          <article className='card-map' key={i.id}>
            ...
            <aside className='category-abs' style={{ background: i.category === "men's clothing" ? "#8867D4" : i.category == "electronics" ? "green" : i.category == "jewelery"?"#D77238" : "#09A896" }}>{i.category}</aside>
          </article>
        ))
      }
    </div>
